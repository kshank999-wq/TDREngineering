...
| `docs/MARKETING-LIBRARY.md` | Flyers and brochures, with share links that stay current |
| `docs/PROSPECT-LISTS.md` | Prospect lists, importing spreadsheets, and the do-not-email rule |
